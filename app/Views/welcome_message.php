...
<head>
    <meta charset="UTF-8">
    <title>Sistem Layanan Buku Tamu Digital Perpustakaan Provinsi Jawa Tengah</title>
        ...
        <ul>
            <li class="logo">
                <a href="/" target="_blank">
                    <svg role="img" aria-label="Logo Perpustakaan" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" height="44" fill="#1e40af"><path d="M4 2h16c1.1 0 2 .9 2 2v18c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2m0 2v16h16V4H4m2 2h12v2H6V6m0 3h12v2H6V9m0 3h12v2H6v-2z"/></svg>
                </a>
            </li>
            ...
            <li class="menu-item hidden"><a href="/" target="_blank">Layanan</a>
            </li>
            <li class="menu-item hidden"><a href="/" target="_blank">Tentang</a></li>
            <li class="menu-item hidden"><a
                    href="/" target="_blank">Hubungi Kami</a>
            </li>
        </ul>
    </div>
