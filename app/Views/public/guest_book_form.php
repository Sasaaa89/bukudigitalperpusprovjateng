...
<div>
    <div class="text-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800 mb-2">Buku Tamu</h1>
        <p class="text-gray-600">Daftarkan kunjungan Anda ke perpustakaan</p>
    </div>
    ...
    <form action="/form/guest-book" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <?php elseif ($field['field_type'] === 'file'): ?>
                        <div class="relative">
                            ...
                            <p class="text-xs text-gray-500 mt-1">
                                ...
                                Format: PDF, DOC, atau DOCX (Max: 20MB)
                            </p>
                        </div>
        ...
        <?php if (!empty($fields)): ?>
            <div class="flex justify-between items-center pt-6 border-t border-gray-200">
                ...
                <button type="submit" class="bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition duration-200">
                    <i class="fas fa-pen-fancy mr-2"></i>Daftar ke Buku Tamu
                </button>
            </div>
        <?php endif; ?>
    </form>
