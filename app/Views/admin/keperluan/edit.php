...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center mb-6">
        ...
        <h2 class="text-2xl font-bold text-gray-800">Edit Keperluan</h2>
    </div>
        ...
        <form method="POST" class="space-y-6">
            <div>
                ...
                <input type="text" id="nama_keperluan" name="nama_keperluan" required
                       value="<?= esc($keperluan['nama_keperluan']) ?>"
            ...
            <div>
                ...
                <textarea id="deskripsi" name="deskripsi" rows="3"
                          class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          placeholder="Masukkan deskripsi keperluan"><?= esc($keperluan['deskripsi']) ?></textarea>
            </div>

            <div>
                <label class="flex items-center">
                    <input type="checkbox" name="is_active" value="1" <?= $keperluan['is_active'] ? 'checked' : '' ?>
