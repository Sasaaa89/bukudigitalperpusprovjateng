...
<head>
    ...
    <title><?= $title ?? 'Perpustakaan' ?> - Sistem Layanan Buku Tamu Digital Perpustakaan Provinsi Jawa Tengah</title>
    ...
    <div class="container mx-auto px-4 py-8 relative z-10">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="text-center mt-8 text-gray-500 text-sm">
                <p>&copy; <?= date('Y') ?> Sistem Layanan Buku Tamu Digital Perpustakaan Provinsi Jawa Tengah</p>
            </div>
        </div>
    </div>
</body>
